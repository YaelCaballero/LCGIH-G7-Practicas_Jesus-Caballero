...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 3 Jesús Caballero", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate( model, 1.0f, glm::normalize(glm::vec3( 1.0f, -1.0f, 0.0f )) ); // use to compare orthographic and perspective projection
		...
		//view = glm::translate(view, glm::vec3(300, 300, -1200));
